# Setting Up SantiBot on Windows from source

### Prerequisites

- Windows 10 or later (64-bit)
- [.net 8 sdk](https://dotnet.microsoft.com/download/dotnet/8.0)
- If you want santi to play music: [Visual C++ 2010 (x86)] and [Visual C++ 2017 (x64)] (both are required, you may install them later)
...
2. `git clone https://github.com/santi-bot/santibot -b v6 --depth 1`
3. `cd santibot/src/SantiBot`
...
6. Run the bot `dotnet SantiBot.dll`
7. 🎉 Enjoy
...
1. Stop the bot
    - ⚠️ Make sure you don't have your database, credentials or any other santibot folder open in some application, this might prevent some of the steps from executing successfully
...
5. Build the bot again
    - `dotnet run -c Release src/SantiBot/`
...
- [ffmpeg]
- [yt-dlp]
    - Click to download the `yt-dlp.exe` file, then move `yt-dlp.exe` to a path that's in your PATH environment variable. If you don't know what that is, just move the `yt-dlp.exe` file to your santibot's output folder.

...
- It is a dynamic module/plugin/cog system for SantiBot introduced in **SantiBot 4.1.0**

- Allows developers to add custom functionality to Santi without modifying the original code
...
No easy way at the moment, except asking in the `#dev-and-modding` chat in [#SantiLog server](https://discord.santi.bot)

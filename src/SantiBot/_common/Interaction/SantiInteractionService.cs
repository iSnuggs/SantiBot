...
public class SantiInteractionService : ISantiInteractionService, INService
{
    private readonly DiscordSocketClient _client;

    public SantiInteractionService(DiscordSocketClient client)
    {
        _client = client;
    }
    ...
    public SantiInteractionBase Create(
        ...
        => new SantiButtonInteractionHandler(_client,
            userId,
            button,
            onTrigger,
            onlyAuthor: true,
    ...
    public SantiInteractionBase Create(
        ...
        Func<SocketMessageComponent, Task> onTrigger,
        bool singleUse = true)
        => new SantiButtonSelectInteractionHandler(_client,
            userId,
            menu,
            onTrigger,
            onlyAuthor: true,
    ...
    public SantiInteractionBase Create(
        ...
        => Create(userId,
            ...
            async (smc) =>
            {
                ...
                var modalHandler = new SantiModalSubmitHandler(_client,
                    userId,
                    modal.CustomId,
                    onTrigger,
                    true);

#nullable disable
using SantiBot.Modules.Permissions;

namespace SantiBot.Common.TypeReaders;

public sealed class ModuleTypeReader : SantiTypeReader<ModuleInfo>
{
...
public sealed class ModuleOrExprTypeReader : SantiTypeReader<ModuleOrExpr>
{
    private readonly CommandService _cmds;

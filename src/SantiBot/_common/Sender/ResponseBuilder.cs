...
public sealed partial class ResponseBuilder
{
    ...
    private SantiInteractionBase? inter;
    ...
    public ResponseBuilder Interaction(SantiInteractionBase? interaction)
    {
        inter = interaction;
        return this;
    }
...
public sealed class SourcedPaginatedResponseBuilder<T> : PaginatedResponseBuilder
{
    ...
    public Func<int, Task<SantiInteractionBase>>? InteractionFunc { get; private set; }
    ...
    public SourcedPaginatedResponseBuilder<T> Interaction(Func<int, Task<SantiInteractionBase>> func)
    {
        InteractionFunc = func; //async (i) => await func(i);
        return this;
    }

    public SourcedPaginatedResponseBuilder<T> Interaction(SantiInteractionBase inter)
    {

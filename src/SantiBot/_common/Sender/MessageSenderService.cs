...
public sealed class MessageSenderService : IMessageSenderService, INService
{
    ...
    public SantiEmbedBuilder CreateEmbed(ulong? guildId = null)
        => new SantiEmbedBuilder(_bcs, guildId is { } gid ? _gcs.GetColors(gid) : null);
}

public class SantiEmbedBuilder : EmbedBuilder
{
    private readonly Color _okColor;
    private readonly Color _errorColor;
    private readonly Color _pendingColor;

    public SantiEmbedBuilder(BotConfigService bcsData, Colors? guildColors = null)
    {

...
public sealed class Creds : IBotCreds
{
    ...
    [Comment("""
             ...
             note: If you are planning to have more than one shard, then you must change botCache to 'redis'.
                   Also, in that case you should be using SantiBot.Coordinator to start the bot, and it will correctly override this value.
             """)]
    ...
    [Comment("""
             ...
             """)]
    public string SantiAiToken { get; set; }
    ...
    [Comment("""Settings for voting system for discordbots. Meant for use on global SantiBot.""")]
...
//     public string PolygonIoApiKey { get; set; }
    ...
    public Creds()
    {
        ...
        {
            Type = "sqlite",
            ConnectionString = "Data Source=data/SantiBot.db"
        };

#nullable disable
using SantiBot.Modules.SantiExpressions;

namespace SantiBot.Common.TypeReaders;

public sealed class CommandOrExprTypeReader : SantiTypeReader<CommandOrExprInfo>
{
    private readonly CommandService _cmds;
    private readonly ICommandHandler _commandHandler;
    private readonly SantiExpressionsService _exprs;

    public CommandOrExprTypeReader(CommandService cmds, SantiExpressionsService exprs, ICommandHandler commandHandler)
    {
        _cmds = cmds;
        _exprs = exprs;

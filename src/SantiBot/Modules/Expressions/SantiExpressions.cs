...
[Name("Expressions")]
public sealed class SantiExpressions(IBotCreds creds, IHttpClientFactory clientFactory)
    : SantiModule<SantiExpressionsService>
{
    ...
    private SantiInteractionBase CreateEditInteraction(kwum id, SantiExpression found)
    {

#nullable disable
using SantiBot.Modules.Help.Common;
using SantiBot.Modules.Help.Services;
using Santi.Common.Medusa;

namespace SantiBot.Modules.Help;
...
public sealed partial class Help : SantiModule<HelpService>
{
    ...
    public async Task Modules(int page = 1)
    {
        ...
        SantiInteractionBase inter = null;
    ...
    public async Task Donate()
    {
        var eb = CreateEmbed()
            .WithOkColor()
            .WithTitle("Thank you for considering to donate to the SantiBot project!");
        ...
        eb
            ...
            .AddField("Donation Instructions",
                $"""
                 🗒️ Before pledging it is recommended to open your DMs as SantiBot will send you a welcome message with instructions after you pledge has been processed and confirmed.
                 ...
                 **Step 3** ⏰ Wait a short while (usually 1-3 minutes) ⏰
                 ...
                 SantiBot will DM you the welcome instructions, and you will receive your rewards!
                 🎉 **Enjoy!** 🎉
                 """);

#nullable disable
using SantiBot.Modules.Gambling.Common.AnimalRacing.Exceptions;
using SantiBot.Modules.Games.Common;
using SantiBot.Modules.Games.Quests;

namespace SantiBot.Modules.Gambling.Common.AnimalRacing;

...
public partial class Gambling : GamblingModule<GamblingService>
{
    ...
    private SantiInteractionBase CreateRemindMeInteraction(int period)
        => _inter
            .Create(ctx.User.Id,
                new ButtonBuilder(
                    label: "Remind me",
    ...
    private SantiInteractionBase CreateRemindMeInteraction(double ms)
        => _inter
            .Create(ctx.User.Id,
                new ButtonBuilder(
                    label: "Remind me",
    ...
    private SantiInteractionBase CreateTimelyInteraction()
        => _inter
            .Create(ctx.User.Id,
                new ButtonBuilder(
                    label: "Timely",
    ...
    public async Task Vote()
    {
        ...
        var inter = CreateRemindMeInteraction(12) as SantiButtonInteractionHandler;
        var eb = CreateEmbed()
          .WithOkColor()
          .WithDescription(msg);
    ...
    public async Task Raffle([Leftover] IRole role = null)
    {
        ...
        var usr = membersArray[new SantiRandom().Next(0, membersArray.Length)];
        await Response()
    ...
    private SantiInteractionBase CreateCashInteraction()
    ...
    private SantiInteractionBase CreateRakebackInteraction()
        => _inter.Create(ctx.User.Id,
            new ButtonBuilder(

...
/// <summary>
/// Executes a sequence of SantiBot commands with a configurable delay between each.
...
public sealed class RunCommandChainTool(ICommandHandler cmdHandler) : IAiTool, INService
{
    ...
    public string Description =>
        "Execute a sequence of SantiBot commands in order, with a delay between each. " +

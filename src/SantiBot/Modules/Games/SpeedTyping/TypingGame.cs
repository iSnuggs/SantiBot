#nullable disable
using CommandLine;
using SantiBot.Modules.Games.Services;
using System.Diagnostics;

namespace SantiBot.Modules.Games.Common;
...
public class TypingGame
{
    ...
    public string GetRandomSentence()
    {
        if (_games.TypingArticles.Any())
            return _games.TypingArticles[new SantiRandom().Next(0, _games.TypingArticles.Count)].Text;
    ...
    public class Options : ISantiCommandOptions
    {
        [Option('s',
            "start-time",
            Default = 5,

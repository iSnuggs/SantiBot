...
using SantiBot.Modules.Music.Services;
...
{
    [Group]
    public sealed partial class PlaylistCommands : SantiModule<IMusicService>
    {
        ...
        public class PlaylistLoadOptions : ISantiCommandOptions
        {
            [Option("shuffle")]
        ...
        [Cmd]
        [RequireContext(ContextType.Guild)]
        [SantiOptions<PlaylistLoadOptions>]

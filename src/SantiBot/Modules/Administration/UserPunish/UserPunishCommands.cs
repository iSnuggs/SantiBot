...
{
    [Group]
    public partial class UserPunishCommands : SantiModule<UserPunishService>
    {
        public enum AddRole
        {
            AddRole
        ...
        [SantiOptions<WarnExpireOptions>]
        [Priority(1)]
        ...
        public class WarnExpireOptions : ISantiCommandOptions
        {

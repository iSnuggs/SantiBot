...
/// </summary>
public static class WnHTestHelper
{
    /// <summary>
    ...
    /// <summary>
    /// Inserts a WaifuFan record (active fan, LeftAt = null).
    /// </summary>
        ...
        ulong waifuUserId)
    {
        ...
        return await ctx.GetTable<WaifuFan>()
            .FirstAsyncLinqToDB(x => x.UserId == userId && x.WaifuUserId == waifuUserId && x.LeftAt == null);
    }
